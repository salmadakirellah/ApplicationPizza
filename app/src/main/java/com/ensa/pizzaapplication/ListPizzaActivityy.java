...
import com.ensa.pizzaapplication.adapter.ProduitAdapter;
import com.ensa.pizzaapplication.classes.Produit;
import com.ensa.pizzaapplication.service.DetailsActivity;
import com.ensa.pizzaapplication.service.ProduitService;


public class ListPizzaActivityy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_pizza_activityy);
       ...
       list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListPizzaActivityy.this, DetailsActivity.class);
            ...
            //    intent.putExtra("ville",ville.getSelectedItem().toString());
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ListPizzaActivityy.this);
                alertDialogBuilder.setMessage("Voulez vous supprimer ce pizza");
                alertDialogBuilder.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        TextView idd = view.findViewById(R.id.id);
                        ps.delete(ps.findById(Integer.parseInt(idd.getText().toString())));
                        list.setAdapter(new ProduitAdapter(ps.findAll(), ListPizzaActivityy.this));
                        Toast.makeText(ListPizzaActivityy.this, idd.getText().toString(), Toast.LENGTH_LONG).show();
